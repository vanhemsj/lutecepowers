...
TaskCreate({ subject: "Phase 9: Templates", description: "Read phases/phase-9-templates.md then execute ALL steps. Rewrite admin templates to v8 macros, migrate skin templates, remove jQuery. Verify: grep checks + visual check (no build).", activeForm: "Migrating templates..." })
...
TaskCreate({ subject: "Phase 11: JspBean migration", description: "Read phases/phase-11-jspbean.md then execute ALL steps. Verify: grep checks (no build).", activeForm: "Migrating JspBeans..." })
...
TaskUpdate({ taskId: "<phase9_id>",  addBlockedBy: ["<phase3_id>"] })
TaskUpdate({ taskId: "<phase10_id>", addBlockedBy: ["<phase4_id>", "<phase5_id>", "<phase6_id>", "<phase7_id>", "<phase8_id>", "<phase9_id>"] })
...
Phases 4-9 share the same blockedBy (Phase 3) and unblock independently.
